    ...
    <aside class="sidebar bg-primary w-64 flex-shrink-0 flex flex-col border-r border-secondary h-full">
        <div class="p-4 border-b border-secondary flex items-center justify-between">
            <div class="flex items-center">
                ...
                <span class="logo-text text-xl font-bold text-lightest">Harmony Admin</span>
            </div>
        ...
        <div class="flex-1 overflow-y-auto py-4">
            <nav>
                <ul>
                    <li class="px-4">
                        <a href="#" class="flex items-center py-3 px-3 text-lightest bg-secondary bg-opacity-30 rounded-lg">
                            <i class="fas fa-tachometer-alt mr-3"></i>
                            <span class="sidebar-text">Dashboard</span>
                        </a>
                    </li>
                    <li class="px-4 mt-2">
                        <a href="#" class="flex items-center py-3 px-3 text-gray-300 hover:text-lightest hover:bg-secondary hover:bg-opacity-20 rounded-lg">
