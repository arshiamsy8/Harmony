...
<div class="content flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-primary border-b border-secondary p-4 flex items-center justify-between">
            <div class="flex items-center">
                <h1 class="text-xl font-semibold">Upload Music</h1>
            </div>
            ...
            <div class="bg-primary rounded-lg p-6 border border-secondary mb-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex justify-end self-center">
                        <button type="submit" class="bg-secondary h-10 text-white px-6 py-2 rounded-lg hover:bg-primary/80 transition">
                            Upload Music
                        </button>
                    </div>
                </form>
