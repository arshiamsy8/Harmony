            ...
            <div class="p-4">
                ...
                <nav class="mt-8">
                    <ul>
                        ...
                        <li class="mb-4">
                            <a href="#" class="flex items-center text-gray-300 hover:text-lightest">
                ...
                <div class="mt-8">
                    ...
                    <ul>
                        <li class="mb-3">
                            <a href="#" class="text-gray-300 hover:text-lightest">Recently Played</a>
                        </li>
                        <li class="mb-3">
                            <a href="#" class="text-gray-300 hover:text-lightest">Liked Songs</a>
                        </li>
                        <li class="mb-3">
                            <a href="#" class="text-gray-300 hover:text-lightest">Workout Mix</a>
                        </li>
                        <li class="mb-3">
                            <a href="#" class="text-gray-300 hover:text-lightest">Chill Vibes</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="mb-8">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="#" class="text-sm text-gray-300 hover:text-lightest">See all</a>
                    </div>
                    ...
                    card.innerHTML = `
                        ...
                        <div class="flex justify-between items-center mt-2">
                            ...
                            <div class="flex gap-2">
                                <a href="/music/edit/${music.id}" class="text-blue-400 text-sm hover:text-blue-300">Edit</a>
                                <form method="POST" action="/music/delete/${music.id}" onsubmit="return confirm('Are you sure?');">
                                    <input type="hidden" name="_method" value="DELETE">
                                    <input type="hidden" name="_token" value="${csrfToken}">
                                    <button type="submit" class="text-red-400 text-sm hover:text-red-300">Delete</button>
                                </form>
                            </div>
                        </div>
                    `;
